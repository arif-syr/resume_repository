...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
        ...
        \textbf{General}{: Agile, Azure, Customer Service, Data Scraping, Data Analysis, RDBMS Design} \\
        \textbf{Frameworks/Tools}{: Linux, Docker, ROS, scikit-learn, MongoDB, React, Node.js, Express}
        }}
\end{itemize}
